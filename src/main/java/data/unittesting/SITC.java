...
import data.implementations.ancientunits.SkirmisherInfantry;
...
public class SITC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        attacker = new SkirmisherInfantry("Royal Horse Archers", 80, 800,
                20, 30, 7, 240, 4, 1.2);
        System.out.println("Testing unit: " + attacker.getUnitName());
        ...
        attacker = new SkirmisherInfantry("Armoured Horse Skirmishers",
